...
#ifndef GOOGLE_PROTOBUF_INCLUDED_struct_5flite_2eproto
...
extern Struct_FieldsEntry_DoNotUseDefaultTypeInternal
...
PROTOBUF_NAMESPACE_OPEN
template <>
::google::protobuf::ListValue *Arena::CreateMaybeMessage<::google::protobuf::ListValue>(Arena *);
template <>
::google::protobuf::Struct *Arena::CreateMaybeMessage<::google::protobuf::Struct>(Arena *);
template <>
::google::protobuf::Struct_FieldsEntry_DoNotUse *
Arena::CreateMaybeMessage<::google::protobuf::Struct_FieldsEntry_DoNotUse>(Arena *);
...
template <typename T> inline const std::string &NullValue_Name(T enum_t_value) {
  static_assert(::std::is_same<T, NullValue>::value || ::std::is_integral<T>::value,
...
class Struct_FieldsEntry_DoNotUse
    : public ::PROTOBUF_NAMESPACE_ID::internal::MapEntryLite<
...
public:
  typedef ::PROTOBUF_NAMESPACE_ID::internal::MapEntryLite<
      Struct_FieldsEntry_DoNotUse, std::string, ::google::protobuf::Value,
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::TYPE_STRING,
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::TYPE_MESSAGE, 0>
      SuperType;
  ...
  static bool ValidateKey(std::string *s) {
    return ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
        s->data(), s->size(), ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::PARSE,
...
class Struct
    : public ::PROTOBUF_NAMESPACE_ID::
          MessageLite /* @@protoc_insertion_point(class_definition:google.protobuf.Struct) */ {
public:
  Struct();
  virtual ~Struct();

  Struct(const Struct &from);
  Struct(Struct &&from) noexcept : Struct() { *this = ::std::move(from); }
  ...
  inline ::PROTOBUF_NAMESPACE_ID::Arena *GetArena() const final { return GetArenaNoVirtual(); }
  inline void *GetMaybeArenaPointer() const final { return MaybeArenaPtr(); }
  ...
  inline Struct *New() const final { return CreateMaybeMessage<Struct>(nullptr); }
...
private:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() { return "google.protobuf.Struct"; }
...
public:
  ...
  void clear_fields();
  const ::PROTOBUF_NAMESPACE_ID::Map<std::string, ::google::protobuf::Value> &fields() const;
  ::PROTOBUF_NAMESPACE_ID::Map<std::string, ::google::protobuf::Value> *mutable_fields();
...
class Value
    : public ::PROTOBUF_NAMESPACE_ID::
          MessageLite /* @@protoc_insertion_point(class_definition:google.protobuf.Value) */ {
public:
  Value();
  virtual ~Value();

  Value(const Value &from);
  Value(Value &&from) noexcept : Value() { *this = ::std::move(from); }
  ...
  inline Value *New() const final { return CreateMaybeMessage<Value>(nullptr); }
...
private:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() { return "google.protobuf.Value"; }
...
public:
  ...
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED("The unsafe_arena_ accessors for"
                                     "    string fields are deprecated and will be removed in a"
                                     "    future release.")
  void unsafe_arena_set_allocated_string_value(std::string *string_value);
...
public:
  ...
  void unsafe_arena_set_allocated_struct_value(::google::protobuf::Struct *struct_value);
  ...
  void unsafe_arena_set_allocated_list_value(::google::protobuf::ListValue *list_value);
...
class ListValue
    : public ::PROTOBUF_NAMESPACE_ID::
          MessageLite /* @@protoc_insertion_point(class_definition:google.protobuf.ListValue) */ {
public:
  ListValue();
  virtual ~ListValue();

  ListValue(const ListValue &from);
  ListValue(ListValue &&from) noexcept : ListValue() { *this = ::std::move(from); }
  ...
  inline ListValue *New() const final { return CreateMaybeMessage<ListValue>(nullptr); }
...
public:
  ...
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::google::protobuf::Value> *mutable_values();
  const ::google::protobuf::Value &values(int index) const;
  ::google::protobuf::Value *add_values();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::google::protobuf::Value> &values() const;
...
private:
  ...
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::google::protobuf::Value> values_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_struct_5flite_2eproto;
};
// ===================================================================
...
// map<string, .google.protobuf.Value> fields = 1;
inline int Struct::fields_size() const { return fields_.size(); }
inline void Struct::clear_fields() { fields_.Clear(); }
inline const ::PROTOBUF_NAMESPACE_ID::Map<std::string, ::google::protobuf::Value> &
Struct::fields() const {
  // @@protoc_insertion_point(field_map:google.protobuf.Struct.fields)
  return fields_.GetMap();
}
inline ::PROTOBUF_NAMESPACE_ID::Map<std::string, ::google::protobuf::Value> *
...
// .google.protobuf.NullValue null_value = 1;
inline bool Value::has_null_value() const { return kind_case() == kNullValue; }
...
// double number_value = 2;
inline bool Value::has_number_value() const { return kind_case() == kNumberValue; }
...
// string string_value = 3;
inline bool Value::has_string_value() const { return kind_case() == kStringValue; }
...
inline void Value::set_string_value(const std::string &value) {
  if (!has_string_value()) {
    ...
    kind_.string_value_.UnsafeSetDefault(
...
inline void Value::unsafe_arena_set_allocated_string_value(std::string *string_value) {
  ...
  if (string_value) {
    ...
    kind_.string_value_.UnsafeArenaSetAllocated(
        &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), string_value,
        GetArenaNoVirtual());
  }
...
// bool bool_value = 4;
inline bool Value::has_bool_value() const { return kind_case() == kBoolValue; }
...
// .google.protobuf.Struct struct_value = 5;
inline bool Value::has_struct_value() const { return kind_case() == kStructValue; }
...
inline void
Value::unsafe_arena_set_allocated_struct_value(::google::protobuf::Struct *struct_value) {
  clear_kind();
  if (struct_value) {
...
inline ::google::protobuf::Struct *Value::mutable_struct_value() {
  if (!has_struct_value()) {
    clear_kind();
    set_has_struct_value();
    kind_.struct_value_ = CreateMaybeMessage<::google::protobuf::Struct>(GetArenaNoVirtual());
  }
...
// .google.protobuf.ListValue list_value = 6;
inline bool Value::has_list_value() const { return kind_case() == kListValue; }
...
inline const ::google::protobuf::ListValue &Value::list_value() const {
  ...
  return has_list_value() ? *kind_.list_value_
                          : *reinterpret_cast<::google::protobuf::ListValue *>(
...
inline ::google::protobuf::ListValue *Value::mutable_list_value() {
  if (!has_list_value()) {
    clear_kind();
    set_has_list_value();
    kind_.list_value_ = CreateMaybeMessage<::google::protobuf::ListValue>(GetArenaNoVirtual());
  }
...
// repeated .google.protobuf.Value values = 1;
inline int ListValue::values_size() const { return values_.size(); }
inline void ListValue::clear_values() { values_.Clear(); }
inline ::google::protobuf::Value *ListValue::mutable_values(int index) {
  // @@protoc_insertion_point(field_mutable:google.protobuf.ListValue.values)
  return values_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::google::protobuf::Value> *
...
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::google::protobuf::Value> &
...
#include <google/protobuf/port_undef.inc>
#endif // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_struct_5flite_2eproto
